...
function slide(wrapper, items) {
  ...
  function checkIndex() {
    ...
    if (index == slidesLength - itemsToShow) {
      items.style.left = `${-((slidesLength - itemsToShow - 1) * slideSize)}px`;
      index = slidesLength - itemsToShow - 1;
    }
...
if (carouselWrapperId) {
  slide(carouselWrapperId, carouselItems);
